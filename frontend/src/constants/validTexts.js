const validText = {
  ...
  organization: 'Název organizace smí obsahovat písmena, čísla, mezery a nesmí být delší než 50 znaků.',
  ico: 'IČO nemá správný formát.',
  email: 'E-mail nemá správný formát.',
  phoneNumber: 'Telefonní číslo nemá správný formát.',
  street: 'Název ulice smí obsahovat písmena, čísla, mezery a nesmí být delší než 50 znaků.',
